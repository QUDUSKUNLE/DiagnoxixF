...
export const mockCenters: DiagnosticCenter[] = [
  ...
  {
    id: '2',
    name: 'Elite Medical Labs',
    address: '456 Medical Avenue, Victoria Island',
    latitude: 6.4281,
    longitude: 3.4219,
  ...
  },
  {
    ...
    address: '789 Health Boulevard, Lekki',
    latitude: 6.4554,
    longitude: 3.4711,
  ...
  {
    id: '4',
    name: 'Prime Care Diagnostics',
    address: '321 Wellness Road, Ikeja',
    latitude: 6.5244,
    longitude: 3.3166,
  ...
  },
  {
    ...
    address: '654 Diagnosis Way, Surulere',
    latitude: 6.5000,
    longitude: 3.3500,
